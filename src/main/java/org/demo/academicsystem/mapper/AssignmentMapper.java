...
public class AssignmentMapper {
    ...
    public Assignment toEntity(Assignment existingAssignment, AssignmentRequest request) {
    ...
    public AssignmentResponse toResponse(Assignment assignment) {
        ...
        Integer totalStudents = enrollmentRepository.countEnrollmentByCourse_Id(courseId);
